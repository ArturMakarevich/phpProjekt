 ...
 */
final class Version20240618191046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coin_flip (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, result VARCHAR(255) NOT NULL, INDEX IDX_A7051F9767B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE random_number (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, numresult INT NOT NULL, INDEX IDX_867E6AA867B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE roll_dice (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, roll INT NOT NULL, INDEX IDX_38BEC10867B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
